...
java -classpath ./bin:./lib/reflections-0.9.9-RC1-uberjar.jar:./lib/com.google.common_1.0.0.201004262004.jar:./lib/javassist-3.8.0.GA.jar edu.cmu.courses.ds.launchingProcesses.ProcessManager master
